    ...
    <>
      <nav className="bg-white shadow-md px-6 py-4 flex items-center justify-between relative">
        ...
        <div className="hidden md:flex items-center gap-4 ml-auto text-sm font-medium relative">
          ...
          {user ? (
            ...
            <>
              <Link to="/login" className="!text-indigo-600 hover:underline font-medium" style={{ color: "#4f46e5" }}>
                Login
              </Link>
              <Link
                to="/register"
      ...
      {isOpen && (
        <>
          ...
          {/* Mobile Menu Sidebar */}
          <div
            className={`mobile-menu fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-xl z-50 transform transition-transform duration-300 ease-in-out md:hidden ${
            ...
            <div className="p-6 border-t">
              {user ? (
                <button
                  ...
                  className="w-full !bg-red-100 !text-red-600 hover:!bg-red-200 !border-red-200 px-4 py-2 rounded-lg font-medium transition-colors border"
                  style={{ backgroundColor: "#fef2f2", color: "#dc2626", borderColor: "#fecaca" }}
                >
                  Cerrar sesión
                </button>
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Link to="/register" onClick={closeMenu}>
                    <button
                      className="w-full !border-indigo-600 !text-indigo-600 hover:!bg-indigo-50 px-4 py-2 rounded-lg font-medium transition-colors border bg-white"
