                ...
                >
                  <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center bg-white border border-slate-300 rounded overflow-hidden">
                          <button
                            ...
                            className="px-2 py-1 hover:bg-slate-100 transition-colors text-slate-600 hover:text-slate-800 font-bold"
                          >
                            −
                          </button>
                    ...
                    <button
                      ...
                      className="ml-2 p-1 text-red-500 hover:bg-red-50 rounded transition-colors group"
            ...
            <div className="space-y-4">
              ...
              {metodoPagoSeleccionado === "DEUNA" && (
                <>
                  ...
                  {/* File Upload - Aparece inmediatamente después */}
                  <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
                    <div className="flex items-center gap-2 mb-3">
                      <span className="text-lg">📄</span>
